...
Проект для изучения инфраструктуры веб-приложений.

## Тестирование веток
Эта строка добавлена для демонстрации, что CI/CD работает с любых веток!
...
Создайте  машину (Compute Cloud), воспользовавшись инструкцией по ссылке:\
...
3. Флоу фикса к релизу, который запускается вручнуюю:
...
## IP-адрес сервера для проверки

**Приложение развернуто на сервере и доступно по адресу:**

**IP-адрес:** `158.160.189.184`

**Полная ссылка на приложение:** [http://158.160.189.184:3000/hw/store](http://158.160.189.184:3000/hw/store)



# Тестирование CI/CD workflow
# Повторный тест CI/CD
# Повторный тест CI/CD workflow - четверг, 10 июля 2025 г. 13:59:40 (CDT)
# Тест после исправления настроек - четверг, 10 июля 2025 г. 14:06:32 (CDT)
