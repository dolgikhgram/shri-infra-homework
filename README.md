...
## Проверка настроек PR
Проверяем, работают ли настройки для автоматического направления PR в свой репозиторий.

## Финальный тест после удаления upstream
После удаления upstream связи PR должен создаваться в нашем форке! 🎉
